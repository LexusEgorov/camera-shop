    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__info">
          <Link className="footer__logo" to="/catalog/1" aria-label="Переход на главную">
        ...
        <ul className="footer__nav">
          <li className="footer__nav-item">
            ...
            <ul className="footer__list">
              ...
              <li className="footer__item">
                <Link className="link" to="/garanties">Гарантии</Link>
              </li>
              <li className="footer__item">
          ...
          <li className="footer__nav-item">
            ...
            <ul className="footer__list">
              ...
              <li className="footer__item">
                <Link className="link" to="/question">Задать вопрос</Link>
              </li>
            </ul>
          </li>
        </ul>
